...
|`* * *` |executive member of NUSSU |log into the application with the relevant credentials |gain secure access to the application and access features limited to my role only

|`* * *` |executive member of NUSSU |create a new account for the application with my relevant role |gain access to certain features of the application relevant to my role when I log in
